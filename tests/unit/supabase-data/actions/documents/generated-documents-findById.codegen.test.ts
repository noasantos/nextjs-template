/**
 * Unit tests for findByIdGeneratedDocumentsAction
 *
...
describe("findByIdGeneratedDocumentsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdGeneratedDocumentsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdGeneratedDocumentsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(findByIdGeneratedDocumentsAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
