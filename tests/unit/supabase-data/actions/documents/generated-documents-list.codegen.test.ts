/**
 * Unit tests for listGeneratedDocumentsAction
 *
...
describe("listGeneratedDocumentsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listGeneratedDocumentsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listGeneratedDocumentsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listGeneratedDocumentsAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
