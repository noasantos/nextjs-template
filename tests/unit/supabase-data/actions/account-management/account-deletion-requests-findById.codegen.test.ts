/**
 * Unit tests for findByIdAccountDeletionRequestsAction
 *
...
describe("findByIdAccountDeletionRequestsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdAccountDeletionRequestsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdAccountDeletionRequestsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        findByIdAccountDeletionRequestsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
