/**
 * Unit tests for listAccountDeletionRequestsAction
 *
...
describe("listAccountDeletionRequestsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listAccountDeletionRequestsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listAccountDeletionRequestsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listAccountDeletionRequestsAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
