/**
 * Unit tests for findByIdAssistantInvitesAction
 *
...
describe("findByIdAssistantInvitesAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdAssistantInvitesAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdAssistantInvitesAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(findByIdAssistantInvitesAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
