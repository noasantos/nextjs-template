/**
 * Unit tests for findByIdCatalogDocumentTemplatesAction
 *
...
describe("findByIdCatalogDocumentTemplatesAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdCatalogDocumentTemplatesAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdCatalogDocumentTemplatesAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        findByIdCatalogDocumentTemplatesAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
