/**
 * Unit tests for listSubscriptionPlansAction
 *
...
describe("listSubscriptionPlansAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listSubscriptionPlansAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listSubscriptionPlansAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listSubscriptionPlansAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
