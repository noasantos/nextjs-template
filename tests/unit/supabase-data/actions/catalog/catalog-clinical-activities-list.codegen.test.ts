/**
 * Unit tests for listCatalogClinicalActivitiesAction
 *
...
describe("listCatalogClinicalActivitiesAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listCatalogClinicalActivitiesAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listCatalogClinicalActivitiesAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        listCatalogClinicalActivitiesAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
