/**
 * Unit tests for findByIdCalendarEventSeriesExceptionsAction
 *
...
describe("findByIdCalendarEventSeriesExceptionsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdCalendarEventSeriesExceptionsAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdCalendarEventSeriesExceptionsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        findByIdCalendarEventSeriesExceptionsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
