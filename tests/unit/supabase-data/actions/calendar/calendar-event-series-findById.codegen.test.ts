/**
 * Unit tests for findByIdCalendarEventSeriesAction
 *
...
describe("findByIdCalendarEventSeriesAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdCalendarEventSeriesAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdCalendarEventSeriesAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(findByIdCalendarEventSeriesAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
