/**
 * Unit tests for insertCalendarHolidaysAction
 *
...
describe("insertCalendarHolidaysAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(insertCalendarHolidaysAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await insertCalendarHolidaysAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(insertCalendarHolidaysAction({ invalid: "data" } as any)).rejects.toThrow()
    })
    ...
    it("should accept valid input for insert operation", async () => {
      ...
      await expect(insertCalendarHolidaysAction(validInput)).resolves.not.toThrow()
    })
  })
