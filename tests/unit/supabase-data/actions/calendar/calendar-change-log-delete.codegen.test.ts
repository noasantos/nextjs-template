/**
 * Unit tests for deleteCalendarChangeLogAction
 *
...
describe("deleteCalendarChangeLogAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(deleteCalendarChangeLogAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await deleteCalendarChangeLogAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(deleteCalendarChangeLogAction({ invalid: "data" } as any)).rejects.toThrow()
    })
    ...
    it("should accept valid input for delete operation", async () => {
      ...
      await expect(deleteCalendarChangeLogAction(validInput)).resolves.not.toThrow()
    })
  })
