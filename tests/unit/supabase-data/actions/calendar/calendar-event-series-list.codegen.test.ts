/**
 * Unit tests for listCalendarEventSeriesAction
 *
...
describe("listCalendarEventSeriesAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listCalendarEventSeriesAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listCalendarEventSeriesAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listCalendarEventSeriesAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
