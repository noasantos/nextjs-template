/**
 * Unit tests for updateCalendarChangeLogAction
 *
...
describe("updateCalendarChangeLogAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(updateCalendarChangeLogAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await updateCalendarChangeLogAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(updateCalendarChangeLogAction({ invalid: "data" } as any)).rejects.toThrow()
    })
    ...
    it("should accept valid input for update operation", async () => {
      ...
      await expect(updateCalendarChangeLogAction(validInput)).resolves.not.toThrow()
    })
  })
