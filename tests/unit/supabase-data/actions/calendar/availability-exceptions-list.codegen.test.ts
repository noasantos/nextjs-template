/**
 * Unit tests for listAvailabilityExceptionsAction
 *
...
describe("listAvailabilityExceptionsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listAvailabilityExceptionsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listAvailabilityExceptionsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listAvailabilityExceptionsAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
