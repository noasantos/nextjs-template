/**
 * Unit tests for listCalendarHolidaysAction
 *
...
describe("listCalendarHolidaysAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listCalendarHolidaysAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listCalendarHolidaysAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listCalendarHolidaysAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
