/**
 * Unit tests for updateAvailabilityExceptionsAction
 *
...
describe("updateAvailabilityExceptionsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(updateAvailabilityExceptionsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await updateAvailabilityExceptionsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(updateAvailabilityExceptionsAction({ invalid: "data" } as any)).rejects.toThrow()
    })
    ...
    it("should accept valid input for update operation", async () => {
      ...
      await expect(updateAvailabilityExceptionsAction(validInput)).resolves.not.toThrow()
    })
  })
