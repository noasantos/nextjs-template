/**
 * Unit tests for insertCalendarEventSeriesExceptionsAction
 *
...
describe("insertCalendarEventSeriesExceptionsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(insertCalendarEventSeriesExceptionsAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await insertCalendarEventSeriesExceptionsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        insertCalendarEventSeriesExceptionsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
    ...
    it("should accept valid input for insert operation", async () => {
      ...
      // TODO: Replace with actual valid input for calendar_event_series_exceptions
      const validInput = {} as any

      await expect(insertCalendarEventSeriesExceptionsAction(validInput)).resolves.not.toThrow()
    })
  })
