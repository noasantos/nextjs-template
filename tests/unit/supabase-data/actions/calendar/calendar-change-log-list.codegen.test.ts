/**
 * Unit tests for listCalendarChangeLogAction
 *
...
describe("listCalendarChangeLogAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listCalendarChangeLogAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listCalendarChangeLogAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listCalendarChangeLogAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
