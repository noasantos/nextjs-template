/**
 * Unit tests for findByIdCalendarChangeLogAction
 *
...
describe("findByIdCalendarChangeLogAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdCalendarChangeLogAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdCalendarChangeLogAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(findByIdCalendarChangeLogAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
