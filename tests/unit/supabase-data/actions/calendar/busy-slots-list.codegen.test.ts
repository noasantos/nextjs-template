/**
 * Unit tests for listBusySlotsAction
 *
...
describe("listBusySlotsAction", () => {
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listBusySlotsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listBusySlotsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listBusySlotsAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
