/**
 * Unit tests for findByIdCalendarHolidaysAction
 *
...
describe("findByIdCalendarHolidaysAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdCalendarHolidaysAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdCalendarHolidaysAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(findByIdCalendarHolidaysAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
