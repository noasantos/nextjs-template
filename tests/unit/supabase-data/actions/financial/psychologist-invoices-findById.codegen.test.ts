/**
 * Unit tests for findByIdPsychologistInvoicesAction
 *
...
describe("findByIdPsychologistInvoicesAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdPsychologistInvoicesAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdPsychologistInvoicesAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(findByIdPsychologistInvoicesAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
