/**
 * Unit tests for findByIdGoogleCalendarConnectionsAction
 *
...
describe("findByIdGoogleCalendarConnectionsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdGoogleCalendarConnectionsAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdGoogleCalendarConnectionsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        findByIdGoogleCalendarConnectionsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
