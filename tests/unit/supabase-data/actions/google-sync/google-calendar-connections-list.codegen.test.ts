/**
 * Unit tests for listGoogleCalendarConnectionsAction
 *
...
describe("listGoogleCalendarConnectionsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listGoogleCalendarConnectionsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listGoogleCalendarConnectionsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        listGoogleCalendarConnectionsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
