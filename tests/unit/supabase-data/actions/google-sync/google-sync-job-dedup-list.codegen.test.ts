/**
 * Unit tests for listGoogleSyncJobDedupAction
 *
...
describe("listGoogleSyncJobDedupAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listGoogleSyncJobDedupAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listGoogleSyncJobDedupAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listGoogleSyncJobDedupAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
