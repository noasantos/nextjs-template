/**
 * Unit tests for listGoogleSyncIdempotencyAction
 *
...
describe("listGoogleSyncIdempotencyAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listGoogleSyncIdempotencyAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listGoogleSyncIdempotencyAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listGoogleSyncIdempotencyAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
