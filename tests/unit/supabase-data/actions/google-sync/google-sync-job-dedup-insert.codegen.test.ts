/**
 * Unit tests for insertGoogleSyncJobDedupAction
 *
...
describe("insertGoogleSyncJobDedupAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(insertGoogleSyncJobDedupAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await insertGoogleSyncJobDedupAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(insertGoogleSyncJobDedupAction({ invalid: "data" } as any)).rejects.toThrow()
    })
    ...
    it("should accept valid input for insert operation", async () => {
      ...
      await expect(insertGoogleSyncJobDedupAction(validInput)).resolves.not.toThrow()
    })
  })
