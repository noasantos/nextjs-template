/**
 * Unit tests for listGoogleSyncInboundCoalesceAction
 *
...
describe("listGoogleSyncInboundCoalesceAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listGoogleSyncInboundCoalesceAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listGoogleSyncInboundCoalesceAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        listGoogleSyncInboundCoalesceAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
