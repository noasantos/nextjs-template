/**
 * Unit tests for findByIdGoogleSyncWorkerMetricsAction
 *
...
describe("findByIdGoogleSyncWorkerMetricsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdGoogleSyncWorkerMetricsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdGoogleSyncWorkerMetricsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        findByIdGoogleSyncWorkerMetricsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
