/**
 * Unit tests for updateGoogleSyncWorkerMetricsAction
 *
...
describe("updateGoogleSyncWorkerMetricsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(updateGoogleSyncWorkerMetricsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await updateGoogleSyncWorkerMetricsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        updateGoogleSyncWorkerMetricsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
    ...
    it("should accept valid input for update operation", async () => {
      ...
      await expect(updateGoogleSyncWorkerMetricsAction(validInput)).resolves.not.toThrow()
    })
  })
