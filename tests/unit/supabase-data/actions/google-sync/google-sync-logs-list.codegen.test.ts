/**
 * Unit tests for listGoogleSyncLogsAction
 *
...
describe("listGoogleSyncLogsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listGoogleSyncLogsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listGoogleSyncLogsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listGoogleSyncLogsAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
