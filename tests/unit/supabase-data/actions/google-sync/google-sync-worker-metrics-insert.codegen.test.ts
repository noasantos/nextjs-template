/**
 * Unit tests for insertGoogleSyncWorkerMetricsAction
 *
...
describe("insertGoogleSyncWorkerMetricsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(insertGoogleSyncWorkerMetricsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await insertGoogleSyncWorkerMetricsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        insertGoogleSyncWorkerMetricsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
    ...
    it("should accept valid input for insert operation", async () => {
      ...
      await expect(insertGoogleSyncWorkerMetricsAction(validInput)).resolves.not.toThrow()
    })
  })
