/**
 * Unit tests for updateGoogleCalendarConnectionsAction
 *
...
describe("updateGoogleCalendarConnectionsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(updateGoogleCalendarConnectionsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await updateGoogleCalendarConnectionsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        updateGoogleCalendarConnectionsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
    ...
    it("should accept valid input for update operation", async () => {
      ...
      await expect(updateGoogleCalendarConnectionsAction(validInput)).resolves.not.toThrow()
    })
  })
