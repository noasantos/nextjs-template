/**
 * Unit tests for insertGoogleSyncIdempotencyAction
 *
...
describe("insertGoogleSyncIdempotencyAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(insertGoogleSyncIdempotencyAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await insertGoogleSyncIdempotencyAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(insertGoogleSyncIdempotencyAction({ invalid: "data" } as any)).rejects.toThrow()
    })
    ...
    it("should accept valid input for insert operation", async () => {
      ...
      await expect(insertGoogleSyncIdempotencyAction(validInput)).resolves.not.toThrow()
    })
  })
