/**
 * Unit tests for deleteGoogleSyncInboundCoalesceAction
 *
...
describe("deleteGoogleSyncInboundCoalesceAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(deleteGoogleSyncInboundCoalesceAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await deleteGoogleSyncInboundCoalesceAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        deleteGoogleSyncInboundCoalesceAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
    ...
    it("should accept valid input for delete operation", async () => {
      ...
      await expect(deleteGoogleSyncInboundCoalesceAction(validInput)).resolves.not.toThrow()
    })
  })
