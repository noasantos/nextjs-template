/**
 * Unit tests for deleteGoogleCalendarConnectionsAction
 *
...
describe("deleteGoogleCalendarConnectionsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(deleteGoogleCalendarConnectionsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await deleteGoogleCalendarConnectionsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        deleteGoogleCalendarConnectionsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
    ...
    it("should accept valid input for delete operation", async () => {
      ...
      await expect(deleteGoogleCalendarConnectionsAction(validInput)).resolves.not.toThrow()
    })
  })
