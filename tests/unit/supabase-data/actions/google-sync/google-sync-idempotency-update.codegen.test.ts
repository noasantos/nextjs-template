/**
 * Unit tests for updateGoogleSyncIdempotencyAction
 *
...
describe("updateGoogleSyncIdempotencyAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(updateGoogleSyncIdempotencyAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await updateGoogleSyncIdempotencyAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(updateGoogleSyncIdempotencyAction({ invalid: "data" } as any)).rejects.toThrow()
    })
    ...
    it("should accept valid input for update operation", async () => {
      ...
      await expect(updateGoogleSyncIdempotencyAction(validInput)).resolves.not.toThrow()
    })
  })
