/**
 * Unit tests for insertGoogleSyncInboundCoalesceAction
 *
...
describe("insertGoogleSyncInboundCoalesceAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(insertGoogleSyncInboundCoalesceAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await insertGoogleSyncInboundCoalesceAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        insertGoogleSyncInboundCoalesceAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
    ...
    it("should accept valid input for insert operation", async () => {
      ...
      await expect(insertGoogleSyncInboundCoalesceAction(validInput)).resolves.not.toThrow()
    })
  })
