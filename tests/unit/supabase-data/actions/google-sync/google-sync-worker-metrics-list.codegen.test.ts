/**
 * Unit tests for listGoogleSyncWorkerMetricsAction
 *
...
describe("listGoogleSyncWorkerMetricsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listGoogleSyncWorkerMetricsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listGoogleSyncWorkerMetricsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listGoogleSyncWorkerMetricsAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
