/**
 * Unit tests for deletePsychologistClinicalSessionsAction
 *
...
describe("deletePsychologistClinicalSessionsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(deletePsychologistClinicalSessionsAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await deletePsychologistClinicalSessionsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        deletePsychologistClinicalSessionsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
    ...
    it("should accept valid input for delete operation", async () => {
      ...
      // TODO: Replace with actual valid input for psychologist_clinical_sessions
      const validInput = {} as any

      await expect(deletePsychologistClinicalSessionsAction(validInput)).resolves.not.toThrow()
    })
  })
