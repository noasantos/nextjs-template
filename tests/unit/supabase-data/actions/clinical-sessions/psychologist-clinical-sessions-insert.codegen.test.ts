/**
 * Unit tests for insertPsychologistClinicalSessionsAction
 *
...
describe("insertPsychologistClinicalSessionsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(insertPsychologistClinicalSessionsAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await insertPsychologistClinicalSessionsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        insertPsychologistClinicalSessionsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
    ...
    it("should accept valid input for insert operation", async () => {
      ...
      await expect(insertPsychologistClinicalSessionsAction(validInput)).resolves.not.toThrow()
    })
  })
