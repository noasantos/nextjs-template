/**
 * Unit tests for listPsychologistClinicalSessionsAction
 *
...
describe("listPsychologistClinicalSessionsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listPsychologistClinicalSessionsAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listPsychologistClinicalSessionsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        listPsychologistClinicalSessionsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
