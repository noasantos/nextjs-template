/**
 * Unit tests for listClinicalSessionDetailsAction
 *
...
describe("listClinicalSessionDetailsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listClinicalSessionDetailsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listClinicalSessionDetailsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listClinicalSessionDetailsAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
