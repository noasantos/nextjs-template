/**
 * Unit tests for findByIdClinicalSessionDetailsAction
 *
...
describe("findByIdClinicalSessionDetailsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdClinicalSessionDetailsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdClinicalSessionDetailsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        findByIdClinicalSessionDetailsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
