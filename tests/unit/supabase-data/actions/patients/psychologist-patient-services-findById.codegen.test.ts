/**
 * Unit tests for findByIdPsychologistPatientServicesAction
 *
...
describe("findByIdPsychologistPatientServicesAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdPsychologistPatientServicesAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdPsychologistPatientServicesAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        findByIdPsychologistPatientServicesAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
