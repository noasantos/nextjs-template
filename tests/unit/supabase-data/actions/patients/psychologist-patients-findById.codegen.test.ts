/**
 * Unit tests for findByIdPsychologistPatientsAction
 *
...
describe("findByIdPsychologistPatientsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdPsychologistPatientsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdPsychologistPatientsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(findByIdPsychologistPatientsAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
