/**
 * Unit tests for findByIdPsychologistPatientEmergencyContactsAction
 *
...
describe("findByIdPsychologistPatientEmergencyContactsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdPsychologistPatientEmergencyContactsAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdPsychologistPatientEmergencyContactsAction({} as any).catch(
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        findByIdPsychologistPatientEmergencyContactsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
