/**
 * Unit tests for listPsychologistPatientActivitiesAction
 *
...
describe("listPsychologistPatientActivitiesAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listPsychologistPatientActivitiesAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listPsychologistPatientActivitiesAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        listPsychologistPatientActivitiesAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
