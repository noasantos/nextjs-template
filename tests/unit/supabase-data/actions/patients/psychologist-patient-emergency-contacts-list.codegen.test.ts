/**
 * Unit tests for listPsychologistPatientEmergencyContactsAction
 *
...
describe("listPsychologistPatientEmergencyContactsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listPsychologistPatientEmergencyContactsAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listPsychologistPatientEmergencyContactsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        listPsychologistPatientEmergencyContactsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
