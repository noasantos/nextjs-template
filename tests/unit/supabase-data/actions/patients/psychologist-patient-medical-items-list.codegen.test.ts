/**
 * Unit tests for listPsychologistPatientMedicalItemsAction
 *
...
describe("listPsychologistPatientMedicalItemsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listPsychologistPatientMedicalItemsAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listPsychologistPatientMedicalItemsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        listPsychologistPatientMedicalItemsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
