/**
 * Unit tests for insertPsychologistPatientsAction
 *
...
describe("insertPsychologistPatientsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(insertPsychologistPatientsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await insertPsychologistPatientsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(insertPsychologistPatientsAction({ invalid: "data" } as any)).rejects.toThrow()
    })
    ...
    it("should accept valid input for insert operation", async () => {
      ...
      await expect(insertPsychologistPatientsAction(validInput)).resolves.not.toThrow()
    })
  })
