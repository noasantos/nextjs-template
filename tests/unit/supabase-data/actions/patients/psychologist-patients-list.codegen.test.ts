/**
 * Unit tests for listPsychologistPatientsAction
 *
...
describe("listPsychologistPatientsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listPsychologistPatientsAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listPsychologistPatientsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listPsychologistPatientsAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
