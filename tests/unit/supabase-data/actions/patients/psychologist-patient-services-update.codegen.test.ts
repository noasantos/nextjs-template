/**
 * Unit tests for updatePsychologistPatientServicesAction
 *
...
describe("updatePsychologistPatientServicesAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(updatePsychologistPatientServicesAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await updatePsychologistPatientServicesAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        updatePsychologistPatientServicesAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
    ...
    it("should accept valid input for update operation", async () => {
      ...
      await expect(updatePsychologistPatientServicesAction(validInput)).resolves.not.toThrow()
    })
  })
