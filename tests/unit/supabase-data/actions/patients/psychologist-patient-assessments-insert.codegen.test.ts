/**
 * Unit tests for insertPsychologistPatientAssessmentsAction
 *
...
describe("insertPsychologistPatientAssessmentsAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(insertPsychologistPatientAssessmentsAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await insertPsychologistPatientAssessmentsAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        insertPsychologistPatientAssessmentsAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
    ...
    it("should accept valid input for insert operation", async () => {
      ...
      // TODO: Replace with actual valid input for psychologist_patient_assessments
      const validInput = {} as any

      await expect(insertPsychologistPatientAssessmentsAction(validInput)).resolves.not.toThrow()
    })
  })
