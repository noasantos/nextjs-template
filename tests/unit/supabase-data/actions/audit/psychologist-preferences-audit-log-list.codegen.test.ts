/**
 * Unit tests for listPsychologistPreferencesAuditLogAction
 *
...
describe("listPsychologistPreferencesAuditLogAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listPsychologistPreferencesAuditLogAction({} as any)).rejects.toThrow(
        "Unauthorized"
      )
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listPsychologistPreferencesAuditLogAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        listPsychologistPreferencesAuditLogAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
