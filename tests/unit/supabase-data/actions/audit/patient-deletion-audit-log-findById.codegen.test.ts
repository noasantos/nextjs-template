/**
 * Unit tests for findByIdPatientDeletionAuditLogAction
 *
...
describe("findByIdPatientDeletionAuditLogAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdPatientDeletionAuditLogAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdPatientDeletionAuditLogAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        findByIdPatientDeletionAuditLogAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
