/**
 * Unit tests for findByIdEncryptionAuditLogAction
 *
...
describe("findByIdEncryptionAuditLogAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdEncryptionAuditLogAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdEncryptionAuditLogAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(findByIdEncryptionAuditLogAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
