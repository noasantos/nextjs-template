/**
 * Unit tests for listPsychologistPreferencesAction
 *
...
describe("listPsychologistPreferencesAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listPsychologistPreferencesAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listPsychologistPreferencesAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(listPsychologistPreferencesAction({ invalid: "data" } as any)).rejects.toThrow()
    })
  })
