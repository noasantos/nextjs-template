/**
 * Unit tests for deletePsychologistServicesAction
 *
...
describe("deletePsychologistServicesAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(deletePsychologistServicesAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await deletePsychologistServicesAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(deletePsychologistServicesAction({ invalid: "data" } as any)).rejects.toThrow()
    })
    ...
    it("should accept valid input for delete operation", async () => {
      ...
      await expect(deletePsychologistServicesAction(validInput)).resolves.not.toThrow()
    })
  })
