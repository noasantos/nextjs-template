/**
 * Unit tests for listPsychologistOnboardingStateAction
 *
...
describe("listPsychologistOnboardingStateAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(listPsychologistOnboardingStateAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await listPsychologistOnboardingStateAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        listPsychologistOnboardingStateAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
