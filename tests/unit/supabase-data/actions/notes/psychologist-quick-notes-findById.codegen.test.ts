/**
 * Unit tests for findByIdPsychologistQuickNotesAction
 *
...
describe("findByIdPsychologistQuickNotesAction", () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe("Authentication", () => {
    it("should throw Unauthorized when not authenticated", async () => {
      ...
      await expect(findByIdPsychologistQuickNotesAction({} as any)).rejects.toThrow("Unauthorized")
    })
    ...
    it("should log security.audit on unauthorized access", async () => {
      ...
      await findByIdPsychologistQuickNotesAction({} as any).catch(swallowExpectedError)
  ...
  describe("Input Validation", () => {
    it("should validate input with Zod schema", async () => {
      ...
      await expect(
        findByIdPsychologistQuickNotesAction({ invalid: "data" } as any)
      ).rejects.toThrow()
    })
  })
