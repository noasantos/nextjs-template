-- ============================================================================
-- Migration: Fix daily consolidation to handle NULL category_id entries
-- 
-- Problem: Old entries have category_id = NULL, so the function couldn't find
-- them to delete when charges were marked as non-paid.
-- ============================================================================
...
BEGIN
  ...
  ELSIF v_existing_entry_id IS NOT NULL THEN
    -- Entry exists - update amount and set category_id
