-- ============================================================================
-- Migration: Setup Daily Consolidation System
-- 
-- Changes:
-- 1. Clean up old weekly consolidation entries
-- 2. Remove obsolete functions
-- 3. Create daily consolidation functions
-- ============================================================================

-- ============================================================================
-- STEP 1: Clean up old weekly consolidation data
-- ============================================================================

-- Delete old weekly consolidated entries (format: "Serviços Prestados DD MMM - DD MMM")
...
-- ============================================================================
-- STEP 2: Drop obsolete functions and triggers
-- ============================================================================
...
DROP FUNCTION IF EXISTS public.fix_weekly_consolidation_data() CASCADE;
-- ============================================================================
-- STEP 3: Create daily consolidation function
-- ============================================================================
...
$$;
-- ============================================================================
-- STEP 4: Create recalculation function for single charge
-- ============================================================================
