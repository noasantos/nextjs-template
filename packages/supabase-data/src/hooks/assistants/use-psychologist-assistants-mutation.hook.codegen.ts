/**
 * usePsychologistAssistantsMutation — TanStack Query mutation wrapper for a Server Action.
 *
 ...
 *
 * @module @workspace/supabase-data/hooks/assistants/use-psychologist-assistants-mutation.hook
...
// TODO: import { insertPsychologistAssistantsAction } from "@workspace/supabase-data/actions/assistants/psychologist-assistants-insert.codegen"
// TODO: Narrow the input type based on your action's requirements
type MutationInput = unknown

export function usePsychologistAssistantsMutation(): UseMutationResult<
  unknown,
  Error,
  MutationInput,
  unknown
> {
  ...
  return useMutation({
    mutationFn: async (_input: MutationInput) => {
      ...
      // return insertPsychologistAssistantsAction(_input as any)
      throw new Error("Wire Server Action in mutationFn")
    },
    onSettled: async () => {
      // TODO: Invalidate precise query keys
      await queryClient.invalidateQueries({
        queryKey: assistantsQueryKeys.psychologistAssistants(),
      })
    },
  })
}
