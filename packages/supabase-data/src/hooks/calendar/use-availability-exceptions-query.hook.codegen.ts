/**
 * useAvailabilityExceptionsQuery — TanStack Query wrapper for a Server Action.
 *
 ...
 *
 * @module @workspace/supabase-data/hooks/calendar/use-availability-exceptions-query.hook
...
// TODO: import { listAvailabilityExceptionsAction } from "@workspace/supabase-data/actions/calendar/availability-exceptions-list.codegen"
...
export function useAvailabilityExceptionsQuery(
  ...
  return useQuery({
    queryKey: calendarQueryKeys.availabilityExceptionsList(filters),
    queryFn: async () => {
      // TODO: Replace with actual action call
      // return listAvailabilityExceptionsAction(filters ?? {})
