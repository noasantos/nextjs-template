...
> [`.cursor/rules/tdd-required.mdc`](../../../.cursor/rules/tdd-required.mdc).
...
**Full documentation:**
[docs/standards/rules/tdd-required.md](../../docs/standards/rules/tdd-required.md)

## Rule for Cursor

Cursor MUST enforce TDD:

- **ALWAYS** create test FIRST
- **NEVER** implement without test
