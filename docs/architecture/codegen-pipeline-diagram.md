...
- Identifies files that CAN be deleted/regenerated
- Used by `clean-autogenerated.sh` to know what to delete
- Preserves manual files (no marker)

### What is `.codegen.` Naming Convention?
